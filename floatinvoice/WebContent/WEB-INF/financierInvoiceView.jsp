...
<html lang="en">
 <head>
  ...
  <script>
     finfloatInvoiceListApp.controller('InvoiceFinViewCtrl',function ($scope, $http){
 ...
 <body>
  <table border="1" ng-controller="InvoiceFinViewCtrl" class="table table-striped">
		<tr>
		    <th><a href="" ng-click="sortField = 'amount'"> Amount</th>
			<th><a href="" ng-click="sortField = 'desc'">Description</th>
			<th><a href="" ng-click="sortField = 'startDt'">Start Date</th>
			<th><a href="" ng-click="sortField = 'endDt'">End Date</th>
            <th><a href="" ng-click="sortField = 'invoiceNo'">Invoice Number</th>
            <th><a href="" ng-click="sortField = 'smeCtpy'">SME</th>
			<th><a href="" ng-click="sortField = 'smeCtpy'">Counterparty Name</th>
			<th><a href="" ng-click="sortField = 'status'">Status</th>
    ...
    <tr>
        ...
        <th>
         ...
         <th>
            <input type="text" ng-model="search.status" placeholder="search for status" class="input-sm form-control" />
        </th>
    </tr>
